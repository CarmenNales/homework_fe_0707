...
// Opslaan van aantal cum laude studenten
let countCumLaude = 0;

// For loop door de grades lijst & tel de cijfers van 8 of hoger
for (let i = 0; i < grades.length; i++) {
    if (grades[i] >= 8) {
        countCumLaude++;
    }
}
// Controleer het aantal cum laude studenten
...
// Functie om het aantal cum laude studenten te tellen
...
// Opslaan van alle cijfers bij elkaar
let countAllGrades = 0;

// For loop door de lijst grades & tel de cijfers bij elkaar op
for (let i = 0; i < grades.length; i++) {
    countAllGrades += grades[i];
}
// Bereken het gemiddelde van alle cijfers
const average = (countAllGrades / grades.length);
...
// Functie om het gemiddelde van de cijfers te berekenen
function averageGrade(grades) {
    ...
    // Bereken het gemiddelde van alle cijfers
    let average = (countAllGrades / grades.length);
...
// Maak variabele aan om het hoogste getal in op te slaan
...
for (let i = 0; i <= grades.length - 1; i++) {
    ...
    if (grades[i] >= setHighestGrade) {
        setHighestGrade = grades[i];
    }
}
// Controleer het antwoord
